...
export default function AddCustomer(props) {
  ...
  return (
    <>
      <button onClick={props.toggleShow} className="block mx-auto m-2 bg-purple-600 hover:bg-purple-800 text-white font-bold py-2 px-4 rounded">
                    + Add Customer</button>
      ...
      >
        ...
        <form onSubmit={(e)=>{
          handleClose();
          e.preventDefault();   //This is how we prevent page refresh
          setName('');          //Resetting the states after submission so that we get a clean form next time we want to add an employee
          setIndustry('');
        ...
        <Modal.Footer>
          <button className="bg-slate-400 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded" 
